...
echo ">> done. 请重启后端服务（推荐一键）:"
echo ">>   ./scripts/start-all-services.sh"
echo ">> 或手动重启: tenant(8082) candidate(8085) offer(8087) interview(8086) communication(8089) agent(8091) evolution(8090) llm(8095)"
echo ">> Phase2 API 验收: ./scripts/verify-phase2-e2e.sh"
